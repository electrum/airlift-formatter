...
public class Token {
    ...
    private int indent;
    /** AIRLIFT MODIFICATION: Original indentation from source, or -1 if not set */
    private int originalIndent = -1;
    /** AIRLIFT MODIFICATION: Original number of spaces before this token, or -1 if not set (gofmt-style) */
    private int originalSpacesBefore = -1;
    /** AIRLIFT MODIFICATION: Original number of spaces after this token, or -1 if not set (gofmt-style) */
    private int originalSpacesAfter = -1;
    ...
    public Token(Token tokenToCopy, int newOriginalStart, int newOriginalEnd, TerminalToken newTokenType) {
        ...
        this.originalIndent = tokenToCopy.originalIndent; // AIRLIFT MODIFICATION
        this.originalSpacesBefore = tokenToCopy.originalSpacesBefore; // AIRLIFT MODIFICATION
        this.originalSpacesAfter = tokenToCopy.originalSpacesAfter; // AIRLIFT MODIFICATION
    ...
    /**
     * AIRLIFT MODIFICATION: Set the original indentation from source.
     * Used for preserving original line breaks with correct indentation.
     */
    public void setOriginalIndent(int originalIndent) {
        this.originalIndent = originalIndent;
    }

    /**
     * AIRLIFT MODIFICATION: Get the original indentation from source, or -1 if not set.
     */
    ...
    /**
     * AIRLIFT MODIFICATION: Check if this token has original indentation set.
     */
    public boolean hasOriginalIndent() {
        return this.originalIndent >= 0;
    }

    /**
     * AIRLIFT MODIFICATION: Set the original number of spaces before this token.
     * Used for gofmt-style preservation of exact whitespace between code and comments.
     */
    public void setOriginalSpacesBefore(int originalSpacesBefore) {
        this.originalSpacesBefore = originalSpacesBefore;
    }

    /**
     * AIRLIFT MODIFICATION: Get the original number of spaces before this token, or -1 if not set.
     */
    public int getOriginalSpacesBefore() {
        return this.originalSpacesBefore;
    }

    /**
     * AIRLIFT MODIFICATION: Check if this token has original spaces before count set.
     */
    public boolean hasOriginalSpacesBefore() {
        return this.originalSpacesBefore >= 0;
    }

    /**
     * AIRLIFT MODIFICATION: Set the original number of spaces after this token.
     * Used for gofmt-style preservation of exact whitespace between block comments and following code.
     */
    public void setOriginalSpacesAfter(int originalSpacesAfter) {
        this.originalSpacesAfter = originalSpacesAfter;
    }

    /**
     * AIRLIFT MODIFICATION: Get the original number of spaces after this token, or -1 if not set.
     */
    public int getOriginalSpacesAfter() {
        return this.originalSpacesAfter;
    }

    /**
     * AIRLIFT MODIFICATION: Check if this token has original spaces after count set.
     */
    public boolean hasOriginalSpacesAfter() {
        return this.originalSpacesAfter >= 0;
    }
